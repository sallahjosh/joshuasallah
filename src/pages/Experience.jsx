...
export default function ExperiencePage() {
  ...
  return (
    <>
      <PageHero title="My Experience" subtitle="Professional journey and achievements" />
              ...
              {experience.map((item, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="absolute -left-[50px] md:-left-[54px] top-4 w-9 h-9 rounded-full bg-[#0a0a0f] border-2 border-primary flex items-center justify-center">
